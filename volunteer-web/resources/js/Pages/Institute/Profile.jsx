...
export default function Profile({ auth }) {
    ...
    const profileData = {
        name: institute.institute_name || user.name || "Nama Organisasi",
        email: user.email,
            ...
            <div className="max-w-5xl mx-auto space-y-8">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row items-center gap-8">
                    <div className="w-32 h-32 rounded-full bg-white border border-gray-100 shadow-sm flex items-center justify-center p-2 shrink-0">
                        <img
                            src={user.profile_photo_url || "/assets/Dashboard/Institute/who.png"}
                    ...
                    <div className="text-center md:text-left">
                        <h2 className="text-3xl font-bold text-black">{profileData.name}</h2>
                    </div>
                </div>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                    <div className="flex justify-between items-center mb-6">
                        <h3 className="text-xl font-bold text-black">Informasi Personal</h3>
                    </div>
